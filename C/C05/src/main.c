 ...
 *   - ADICION DE +COMANDOS DE CONTROL!!!
 * - Funcion de uart_tx
 */
...
static bool scan_on = true, print_log = true, send_uart = true;
static bool phy_2M = false;
static uint16_t conn_interv = 6, latency = 0, timeout_ms = 1000;
