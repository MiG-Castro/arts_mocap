...
F5:DA:50:B1:82:88 rojo case violeta
C6:8E:9B:51:3F:33 rojo case blanco
F9:68:A1:B7:CE:A3 micro solo zeidel
EF:59:5F:75:C1:FD mircro solo zeidel
...
static const bt_addr_le_t sensor_wl[] = {
    ...
    {.type = BT_ADDR_LE_RANDOM, .a = { .val = {0x88, 0x82, 0xB1, 0x50, 0xDA, 0xF5}}},
    {.type = BT_ADDR_LE_RANDOM, .a = { .val = {0x33, 0x3F, 0x51, 0x9B, 0x8E, 0xC6}}},
    {.type = BT_ADDR_LE_RANDOM, .a = { .val = {0xA3, 0xCE, 0xB7, 0xA1, 0x68, 0xF9}}},
