...
int main(void)
{
    ...
    while(1) {
        ...
        if (cal_status[0] == 3 && cal_status[1] == 3 && cal_status[2] == 3 && cal_status[3] == 3) {
            bno055_calibration_offsets(false, calib_offsets);
            for(int i = 0; i < 11; i++) printk("%d, ", calib_offsets[i]);
        }
        // FA2F
        // -41, 24, -28, 32624, -443, 10261, 0, -1, -1, 1000, 540
        // -41, 21, -33, 32593, -815, 10299, -1, -1, 0, 1000, 952
        // -16, 51, -35, 32325, -769, 9835, 0, -2, 0, 1000, 778,
        // -20, 52, -35, 32469, -905, 9702, -1, -1, 0, 1000, 472

        // -30, 35, -35, 32469, -905, 9702, -1, -1, 0, 1000, 778,

        // FA86
        // -9, 8, -36, 32583, -850, 10157, -1, 2, 3, 1000, 760
        // -3, 5, -34, 32325, -738, 10118, -1, -2, 3, 1000, 773,
        // -1, 12, -43, 32283, -811, 10109, -1, -1, 2, 1000, 862
